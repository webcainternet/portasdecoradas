                ...
                <div class="<?php echo $content_right; ?> product_page-right">
                        ...
                        <div class="rating-section product-rating-status">
                            <?php if ($review_status) { ?>
								...
								<?php if ($rating) { ?>
                                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                                        <?php if ($rating < $i) { ?>
                                            <span class="fa-stack"><i class="material-design-mark1 fa-stack-1x"></i></span>
											<?php } else { ?>
                    ...
                    <div id="product">
                        ...
                        <ul class="buttons-product">
                            <li>
                                <button type="button" class="product-buttons" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="material-icons-favorite_border"></i> <span  ><?php echo $button_wishlist; ?></span></button>
                            </li>
                            <li>
                                <button type="button" class="product-buttons" onclick="compare.add('<?php echo $product_id; ?>');"><i class="material-icons-shuffle"></i> <span><?php echo $button_compare; ?></span></button>
                            </li>
                        </ul>
                            ...
                            <div class="product-thumb transition <?php if ($product['options']) echo 'options'; ?>">
                                <?php if ($product['options']) { ?>
									...
									<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i>
                                                    ...
                                                    <?php } ?>
                                                <?php } ?>
                                                <button class="btn-icon btn-add" type="button" onclick="cart.addPopup($(this),'<?php echo $product['product_id']; ?>');"><i class="fl-chapps-hand135"></i> <span><?php echo $button_cart; ?></span></button>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="caption">
									...
									<div class="description-small"><?php echo mb_substr($product['description'],0,50,'UTF-8').'...'; ?></div>
