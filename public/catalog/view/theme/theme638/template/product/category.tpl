	...
	<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	  <h2><?php echo $heading_title; ?></h2>
        <?php if ($thumb || $description) { ?>
            <div class="row">
                <?php if ($thumb) { ?>
                    <div class="col-sm-3"><div class="image"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" class="img-thumbnail" /></div></div><br>
                <?php } ?>
                <?php if ($description) { ?>
		...
		<div class="product-layout product-list col-xs-12">
			...
			<div class="image">
				...
				<div class="caption">
					...
					<div class="description-small"><?php echo mb_substr($product['description'],0,70,'UTF-8').'...'; ?></div>
