                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                                    ...
                                    <td class="text-center">
                                        <div class="product-thumb">
                                            <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip"
                                               ...
                                               class="btn-icon fl-chapps-trash54"></a>
                            ...
                            <tr>
                                ...
                                <?php foreach ($products as $product) { ?>
                                    <td class="text-center">
                                        <button type="button" class="product-buttons" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="material-icons-add"></i> <span><?php echo $button_cart; ?></span></button>
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
