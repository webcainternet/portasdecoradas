                            ...
                            <?php foreach ($products as $product) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button"  onclick="cart.add('<?php echo $product['product_id']; ?>');" title="<?php echo $button_cart; ?>" class="product-buttons"><i class="material-icons-add"></i> <span><?php echo $button_cart; ?></span>
                                        </button>
                                    </td>

                                    <td class="text-center" style="width: 0">
                                        <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn-icon"><i class="fl-chapps-trash54"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
