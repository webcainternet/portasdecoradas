...
<div class="container">
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            <h1><i class="fl-chapps-hand135"></i><?php echo $heading_title; ?>
                <?php if ($weight) { ?>
                    &nbsp;(<?php echo $weight; ?>)
                <?php } ?>
            </h1>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 0">
                                        <button type="button" data-toggle="tooltip"
                                                title="<?php echo $button_remove; ?>" class="btn-icon"
                                                onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><i
                                                class="fl-chapps-trash54"></i></button>
                                    </td>
                                </tr>
                            <?php } ?>
