				...
				<div class="product-thumb transition  <?php if ($product['options']) echo 'options' ?>">
                        ...
                        <div class="product-option-wrap">
                            <div class="product-options form-horizontal">
                                <div class="options">
									...
									<button class="product-buttons" type="button" onclick="cart.addPopup($(this),'<?php echo $product['product_id']; ?>');"><i class="material-icons-add"></i> <span><?php echo $button_cart; ?></span></button>
                        ...
                        <div id="quickview_specials_<?php echo $t . $module ?>" class="quickview-style">
                            <div>
                                ...
                                <div class="right col-sm-8">
                                    ...
                                    <button class="product-buttons" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"> <i class="material-icons-add"></i> <span><?php echo $button_cart; ?></span></button>
					...
					<div class="image">                       
						...
						<!-- -->
						 ...
						 <div class="block-quickview"><a class="quickview quickview-special" data-rel="details" href="#quickview_specials_<?php echo $t . $module?>"><span><?php echo $text_quick; ?></span></a></div>
					</div>
