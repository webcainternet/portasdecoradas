                    ...
                    foreach ($featured_products as $product) {
                        ...
                        <div class="product-layout col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="product-thumb transition">
                                <a class="quickview" data-rel="details" href="#quickview_featured_<?php echo $f ?>">
                                    <?php echo $text_quick; ?>
                                </a>
            ...
            <div role="tabpanel" class="tab-pane" id="tab-latest-<?php echo $module; ?>">
                <div class="box clearfix">
                    ...
                    foreach ($latest_products as $product) {
                        ...
                        <div class="product-layout col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="product-thumb transition">
                                <a class="quickview" data-rel="details" href="#quickview_latest_<?php echo $l?>">
                                    <?php echo $text_quick; ?>
                                </a>
                                <div class="quick_info">
                                    <div id="quickview_latest_<?php echo $l?>" class="quickview-style">
                                        <div>
                                            ...
                                            <div class="right col-sm-8">
                                                ...
                                                <div class="cart-button">
                                                    <button class="btn btn-add" data-toggle="tooltip" title="<?php echo $button_cart; ?>" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i></button>
            ...
            <div role="tabpanel" class="tab-pane" id="tab-specials-<?php echo $module; ?>">
                <div class="box clearfix">
                    ...
                    foreach ($special_products as $product) {
                        ...
                        <div class="product-layout col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="product-thumb transition">
                                <a class="quickview" data-rel="details" href="#quickview_special_<?php echo $t ?>">
                                    <?php echo $text_quick; ?>
                                </a>
                                <div class="quick_info">
