			...
			<div class="product-layout col-lg-4 col-md-4 col-sm-4 col-xs-12"> 
                <div class="product-thumb transition <?php if ($product['options']) echo 'options';  ?>">
					...
					<div class="image">
						...
						<div class="block-quickview"><a class="quickview quickview-latest" data-rel="details" href="#quickview_latest_<?php echo $g . $module?>"><span><?php echo $text_quick; ?></span></a></div>					
