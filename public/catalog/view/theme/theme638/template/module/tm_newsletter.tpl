    ...
    <div class="box-content">        
        <form method="post" enctype="multipart/form-data" id="tm-newsletter-form">
            <div class="tm-login-form">
                ...
                <?php if ($description){?><span class="newsletter-description"><?php echo $description;?></span><?php }?> <input type="text" name="tm_newsletter_email" value="" placeholder="<?php echo $entry_mail; ?>" id="input-tm-newsletter-email" class="form-control"/>
            </div>
			<button type="submit" id="tm-newsletter-button" class="dropdown-btn"><i class="material-design-drafts"></i><?php echo $button_subscribe; ?></button>
